...
BOT_SHORT_DESCRIPTION = (
    "ان‌سی‌وی‌پی‌ان پرسرعت — تحویل آنی | پرداخت ریالی | پشتیبانی ۲۴/۷ 🚀"
)
...
REFERRAL_SHARE_DIALOG_TEXT = "⚡ VPN پرسرعت — NC VPN"

REFERRAL_READY_POST = (
    "<b>⚡ NC VPN — VPN سریع و ایمن</b>\n\n"
