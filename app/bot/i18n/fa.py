...
BOT_DESCRIPTION = (
    "نکسورانود؛ انتخابی حرفه‌ای برای دسترسی آزاد و پایدار به اینترنت ⚡\n\n"
    "👩‍💻 پشتیبانی ۲۴ ساعته توسط تیم مجرب\n"
...
BOT_SHORT_DESCRIPTION = (
    "VPN پرسرعت نکسورانود — تحویل آنی | پرداخت ریالی | پشتیبانی ۲۴/۷ 🚀"
)
...
QUANTITY_PROMPT = (
    ...
    "━━━━━━━━━━━━━━━━━━━━\n"
    "چند تا می‌خوای؟\n"
    "بین <b>۱</b> تا <b>{max}</b> عدد رو تایپ کن و بفرست:"
)
...
REFERRAL_NO_STATS = (
    ...
    "<b>۵۰,۰۰۰ تومان</b> به کیف پولت واریز می‌شه. 💸\n\n"
...
REFERRAL_READY_POST = (
    "<b>⚡ Nexoranode — VPN سریع و ایمن</b>\n\n"
...
FAQ_TEXT = (
    ...
    "سرورها دارای پهنای باند بالا هستند. البته گاهی برای تغییرات آی‌پی، ممکن است اختلال‌های کوتاه‌مدت (۵ تا ۱۵ دقیقه‌ای) رخ دهد، اما به طور کلی اتصال پایدار و مناسبی فراهم است.\n\n"
    "━━━━━━━━━━━━━━━━━━━━\n"
